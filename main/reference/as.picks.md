...
A `picks` object when conversion is possible, otherwise `NULL` with a
warning (if `quiet = FALSE`).
...
#> }
#> <bytecode: 0x5599f68bbb00>
#> <environment: 0x5599f68be6d0>
#> 
#> attr(,"label")
#> [1] "Filter"
#> attr(,"datanames")
